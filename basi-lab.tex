...
\item \lstinline|commit()|: registra la transazione corrente (normalmente le connessioni in JDBC sono in auto-commit, il commit viene cioè eseguito al termine dell'esecuzione di ogni comando).
